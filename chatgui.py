...
base = Tk()
base.title("AI_Chatbot")
base.geometry("500x600")
base.resizable(width=FALSE, height=FALSE)

#Create Chat window
ChatLog = Text(base, bd=0, bg="white", height="15", width="50", font="Arial",)
...
EntryBox = Text(base, bd=0, bg="white",width="30", height="6", font="Arial")
